...
import com.ai.superview.TrunkBranchAnnals;
import com.ai.ai.base.activity.BaseActivity;
import com.ai.ai.pager.ViewPagerActivity;
...
public class MainActivity extends BaseActivity implements
    ...
    protected void initView() {
        ...
        findViewById(R.id.iv_more).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mMoreDialog == null) {
                    mMoreDialog = new AlertDialog.Builder(com.ai.ai.MainActivity.this)
                            .setTitle(R.string.list_dialog_title)
                            .setItems(R.array.list_dialog_items, com.ai.ai.MainActivity.this)
                            .create();
                }
                mMoreDialog.show();
            }
...
//                                        mCalendarView.getCurYear(), mCalendarView.getCurMonth(), 23);
                            ...
                            case 6:
                                ...
                                new AlertDialog.Builder(com.ai.ai.MainActivity.this)
        ...
        findViewById(R.id.iv_func).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFuncDialog == null) {
                    mFuncDialog = new AlertDialog.Builder(com.ai.ai.MainActivity.this)
